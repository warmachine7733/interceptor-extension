...
export const assets = ['manifest.json', 'background.js', 'bridge.js', 'rules.js', 'rules-isolated.js', 'page-interceptor.js', 'recording-indicator.js', 'options.html', 'options.css', 'options-utils.js', 'options.js', 'watched-hosts.js', 'icons', 'LICENSE', 'README.md', 'CHANGELOG.md'];
