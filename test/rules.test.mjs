...
const { firstMatch, parseHeaders } = context.globalThis.ApiMockRules;
...
test("parses valid headers and safely handles malformed headers", () => { assert.deepEqual(parseHeaders('{"x-test":"yes"}'), { "x-test": "yes" }); assert.deepEqual(parseHeaders("not json"), {}); });
